$(function() {
  ...
  var rawDeadlines = "2023-12-06 23:59" || [];
  if (rawDeadlines.constructor !== Array) {
    rawDeadlines = [rawDeadlines];
  }
  var parsedDeadlines = [];
  ...
  var rawDeadlines = "2023-10-13 23:59" || [];
  if (rawDeadlines.constructor !== Array) {
    rawDeadlines = [rawDeadlines];
  }
  var parsedDeadlines = [];
  ...
  var rawDeadlines = "2023-09-15 18:00" || [];
  if (rawDeadlines.constructor !== Array) {
    rawDeadlines = [rawDeadlines];
  }
  var parsedDeadlines = [];
  ...
  var rawDeadlines = "2024-03-06 23:59" || [];
  if (rawDeadlines.constructor !== Array) {
    rawDeadlines = [rawDeadlines];
  }
  var parsedDeadlines = [];
  ...
  var rawDeadlines = "2023-06-30 23:59" || [];
  if (rawDeadlines.constructor !== Array) {
    rawDeadlines = [rawDeadlines];
  }
  var parsedDeadlines = [];
